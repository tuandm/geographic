...
abstract class Driver {
	...
	{
		throw new \Dit\Database\Exception('database.not_implemented', __FUNCTION__);
	}
	 ...
	 * @return  array
	 */
	abstract public function list_tables(\Dit\Database $db);
	...
	protected function sql_type($str)
	{
		...
		{
			// Load SQL data types
			$sql_types = $app->config('sql_types');
		}
	...
	public function clear_cache($sql = NULL)
	{
		...
		\Dit\Log::log('debug', 'Database cache cleared: '.get_class($this));
	}
...
abstract class Result implements \ArrayAccess, \Iterator, \Countable {
	 ...
	 *
	 * @throws  new \Dit\Database\Exception
	 */
	final public function offsetSet($offset, $value)
	{
		throw new \Dit\Database\Exception('database.result_read_only');
	}
